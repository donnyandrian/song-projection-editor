...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      {...props}
    >
      <HugeiconsIcon icon={Cancel01Icon} strokeWidth={2.25} className="pointer-events-none" />
    </ComboboxPrimitive.Clear>
  )
}
...
function ComboboxItem({
  ...
  return (
    ...
    >
      ...
      >
        <HugeiconsIcon icon={Tick02Icon} strokeWidth={2.25} className="pointer-events-none size-4 pointer-coarse:size-5" />
      </ComboboxPrimitive.ItemIndicator>
    </ComboboxPrimitive.Item>
  )
}
